...
#require_relative 'word_guesser_game'  # ต้องการ import WordGuesserGame
...
class WordGuesserApp < Sinatra::Base
  ...
  post '/guess' do
    ...
    if @game.repeated_guess?(letter)
      flash[:message] = "You have already used that letter."
    elsif @game.invalid_guess?(letter)
  ...
  # Use existing methods in WordGuesserGame to check if the player has
